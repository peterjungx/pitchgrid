...
<g transform="scale({scale})">
    ...
    <text x="{wcx}" y="{color=='white'?wh-3:bh-3}" fill="{color=="white"?"black":"white"}" font-size="5" text-anchor="middle" alignment-baseline="middle" opacity="{opacity}">{note_label}</text>
    <text x="{wcx}" y="{color=='white'?wh-9:bh-9}" fill="{color=="white"?"black":"white"}" font-size="5" text-anchor="middle" alignment-baseline="middle" opacity="{opacity}">{midi_label}</text>
    <g transform="rotate(-90)">
        <text x="-12" y="0" fill="{color=="white"?"black":"white"}" font-size="5" text-anchor="middle" alignment-baseline="middle" opacity="{opacity}">{pitch_label}</text>
    </g>
</g>
